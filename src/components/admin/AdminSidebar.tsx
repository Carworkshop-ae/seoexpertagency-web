...
function SidebarInner({ role }: { role?: UserRole }) {
  ...
  function isActive(href: string) {
    ...
    // Avoid /admin/seo matching /admin/seo-blog etc.
  ...
  return (
    ...
    >
      ...
      <Link href="/admin" className="block px-3 py-3 border-b" style={{ borderColor: '#374151' }}>
        {collapsed ? (
          <span className="block text-center text-lg font-extrabold text-white">S</span>
        ) : (
          <>
            <span className="text-lg font-extrabold block leading-tight whitespace-nowrap">
              <span className="text-[#4472C4]">SEO</span> <span className="text-white">Expert Agency</span>
            </span>
