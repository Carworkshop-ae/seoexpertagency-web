...
export function CallButton({ settings }: CallButtonProps) {
  ...
  return (
    <a
      ...
      aria-label="Call us"
      title="Call Us"
      className={`group fixed ${bottom} ${side} z-50 hidden sm:flex items-center justify-center w-14 h-14 bg-primary rounded-full shadow-lg hover:bg-[#3560B0] hover:scale-110 transition-all duration-150`}
    >
