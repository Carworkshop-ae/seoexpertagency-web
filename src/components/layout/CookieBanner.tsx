...
export function CookieBanner() {
  ...
  // whatever the page ends with — most importantly a form's submit button,
  // which then silently swallows clicks. Reserve exactly its height at the
  // foot of the page for as long as it is on screen. Measured rather than
  // hard-coded because the bar wraps to two rows on narrow viewports.
  useEffect(() => {
    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center gap-4">
        ...
        <div className="flex gap-3 shrink-0">
          ...
          <button
            onClick={accept}
            className="px-4 py-2 text-sm font-semibold bg-primary rounded-md hover:bg-[#3563B0] transition-colors"
          >
            Accept
          </button>
        </div>
